        ...
        <div className="chat-box">
            ...
            <div className="chat-content">
                ...
                <div className="send-message">
                    <input type="text" className="input-message" ref={inputCursor} 
                        placeholder="enter the message" value={userData.message} 
                        onChange={handleMessage} onKeyPress={handlerEnterKeyPress}/> 
